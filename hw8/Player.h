...
public:
	...
	*/
	...
	//creates all of our virtual functions
	virtual void anchor() {}
	//virtual std::string buildLeft(std::string partial, TrieNode* currNode, size_t row, size_t col) {}
	//virtual bool isLegalMove(std::string givenWord, int x, int y, bool horiz) {} 
