...
testing::AssertionResult runSearch(string & output, string testName, int letters, int rows, int cols, string map) {
	// set up file structure
	std::string executablePath = USER_CODE_DIR "/search";
	std::string testFolder =  TEST_BINARY_DIR "/search_tests/test_files/" + testName;
